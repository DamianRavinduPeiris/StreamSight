...
export default function KafkaUI() {
  ...
  const filteredProducerTopics = topics.filter((t) =>
    t.toLowerCase().includes(producerSearchQuery.toLowerCase())
  );

  const filteredConsumerTopics = topics.filter((t) =>
    t.toLowerCase().includes(consumerSearchQuery.toLowerCase())
  );
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg text-white font-medium transition ${topic && message
